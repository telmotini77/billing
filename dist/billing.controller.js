...
let BillingController = class BillingController {
    ...
    async findAll(queryUserId, headerUserId) {
    ...
    async getXml(id, queryUserId, headerUserId) {
        const userId = queryUserId || headerUserId || '';
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [billing_service_js_1.CreateBillingInvoiceInput]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], BillingController.prototype, "getXml", null);
__decorate([
